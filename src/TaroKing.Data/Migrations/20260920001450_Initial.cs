        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatedMatches = table.Column<int>(type: "INTEGER", nullable: false),
                    MatchesPlayed = table.Column<int>(type: "INTEGER", nullable: false),
                    MatchesAbandoned = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Who = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    Text = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    FromTable = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompulsoryKlop = table.Column<bool>(type: "INTEGER", nullable: false),
                    Contract = table.Column<int>(type: "INTEGER", nullable: false),
                    Declarer = table.Column<int>(type: "INTEGER", nullable: false),
                    DeclarerWon = table.Column<bool>(type: "INTEGER", nullable: false),
                    CardPoints = table.Column<int>(type: "INTEGER", nullable: false),
                    Difference = table.Column<int>(type: "INTEGER", nullable: false),
                    PagatUltimoAnnouncedBy = table.Column<int>(type: "INTEGER", nullable: true),
                    PagatUltimoWonBy = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Radlci = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MatchSeats_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_MatchId_At",
                table: "ChatMessages",
                columns: new[] { "MatchId", "At" });

            migrationBuilder.CreateIndex(
                name: "IX_Events_HandId_Ordinal",
                table: "Events",
                columns: new[] { "HandId", "Ordinal" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Hands_MatchId_Number",
                table: "Hands",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MatchSeats_MatchId_Seat",
                table: "MatchSeats",
                columns: new[] { "MatchId", "Seat" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MatchSeats_UserId",
                table: "MatchSeats",
                column: "UserId");
